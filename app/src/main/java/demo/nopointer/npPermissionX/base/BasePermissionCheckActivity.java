...
public abstract class BasePermissionCheckActivity extends BaseActivity implements NpPermissionCallback {
...
//        requestPermission(loadPermissionsConfig());
    ...
    protected abstract NpRequestPermissionInfo loadPermissionsConfig();
